  ...
  useEffect(() => {
    ...
    function displayPlaces(places) {
      ...
      for (var i = 0; i < places.length; i++) {
        ...
        //     places={places[i]}
        //     map={map}
        //     onMouseOver={() => displayInfowindow(marker, places[i].place_name)}
      ...
      // const listItems = places.map((place, index) => <ListItem key={index} index={index} place={place} map={map} />);

      // // displayPlaces 함수 내부

      // listItems.forEach((listItem) => {
      //   fragment.appendChild(listItem); // root 속성 사용
      // });
