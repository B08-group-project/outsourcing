    ...
    return (
        <>
            ...
            <div className='flex w-full h-screen'>
                <button className='absolute top-[30px] left-[15px] bg-white rounded-2xl bg-sky-100 p-2' onClick={() => navigate(-1)}>뒤로 가기</button>
                <div className='flex-[3] flex justify-center items-center border-solid border-r border-black-600 bg-blue-200'>

                    <div className='flex flex-col w-80 justify-center absolute top-[200px] border-double border-4 border-sky-500 p-8'>
                        ...
                        <input type='email' className='h-8 mb-5 rounded-2xl bg-blue-50' />

                        <label htmlFor='' className='mb-1'>비밀번호</label>
                        <input type='password' className='h-8 mb-5 rounded-2xl bg-blue-50' />

                        <label htmlFor='' className='mb-1'>비밀번호 확인</label>
                        <input type='password' className='h-8 mb-5 rounded-2xl bg-blue-50' />

                        <label htmlFor='' className='mb-1'>닉네임</label>
                        <input type='text' className='h-8 mb-5 rounded-2xl bg-blue-50' />

                        <button className='h-8 mt-2 bg-white rounded-2xl bg-sky-100'>수정 하기</button>
                    </div>
                </div>

                {/* 오른쪽 */}
                <div className='flex-[7] flex-row  '>
                    <h1 className='mx-10 mt-6 mb-4 text-2xl font-bold'>저장된 코스</h1>
